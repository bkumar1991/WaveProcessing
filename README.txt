...
In line 85 of Data_Process_2.py, replace the existing path with the full path to the Example_Data directory on your computer. Save the changes and then run the script python Data_Process_2.py
